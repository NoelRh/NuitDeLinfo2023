  ...
  scene("main", (levelIdx) => {
    ...
    player.onCollide("door", () => {
      if (areAllLightsOff()) {
        ...
        dialog.text = "\xC9teint les lumieres mon gars! Ayant une plus grande responsabilit\xE9 dans les \xE9missions de CO2 et une capacit\xE9 d\u2019action plus grande, les pays d\xE9velopp\xE9s doivent apporter un soutien financier de plus de 100 milliards de dollars par an aux pays en d\xE9veloppement, selon le GIEC. ";
      }
    });
